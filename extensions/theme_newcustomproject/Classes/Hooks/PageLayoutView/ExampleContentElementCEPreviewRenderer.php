...
namespace T3k\newcustomproject\Hooks\PageLayoutView;
 ...
 */
class ExampleContentElementCEPreviewRenderer implements PageLayoutViewDrawItemHookInterface
{
    /**
    ...
    public function preProcess(
        ...
        if ($row['CType'] === 'exampleContentElement') {
            if ($row['picture']) {
