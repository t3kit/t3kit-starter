...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:theme_newcustomproject/Resources/Private/Language/ContentElements/Static/locallang_exampleContentElement.xlf:exampleContentElement.title',
        'exampleContentElement',
        'ce-custom',
        'default'
        ]
);
 ...
 * ===========================
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['exampleContentElement'] = 'ce-custom';
 ...
 * ===========================
 */
$GLOBALS['TCA']['tt_content']['types']['exampleContentElement'] = [
    'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:theme_newcustomproject/Configuration/FlexForms/ExampleContentElement.xml',
    'exampleContentElement'
);
